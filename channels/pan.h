...
#define PanSource	"abpunreliablechannelwith-ltl.pml"
...
#define _nstates6	11	/* p4 */
#define minseq6	78
#define maxseq6	87
#define _endstate6	10

#define _nstates5	11	/* p3 */
#define minseq5	68
#define maxseq5	77
#define _endstate5	10

#define _nstates4	14	/* p2 */
#define minseq4	55
#define maxseq4	67
#define _endstate4	13

#define _nstates3	14	/* p1 */
#define minseq3	42
#define maxseq3	54
#define _endstate3	13

#define _nstates2	10	/* Timer */
#define minseq2	33
#define maxseq2	41
#define _endstate2	9

#define _nstates1	12	/* Receiver */
#define minseq1	22
#define maxseq1	32
#define _endstate1	11

#define _nstates0	23	/* Sender */
#define minseq0	0
#define maxseq0	21
...
#define PTimer	((P2 *)_this)
typedef struct P2 { /* Timer */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 4; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
