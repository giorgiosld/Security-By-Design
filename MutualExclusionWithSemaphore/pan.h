...
#define PanSource	"peterson_mutual_exclusion.pml"
...
#define _nstates2	3	/* invariant */
#define minseq2	24
#define maxseq2	25
#define _endstate2	2

#define _nstates1	13	/* P2 */
#define minseq1	12
#define maxseq1	23
#define _endstate1	12

#define _nstates0	13	/* P1 */
#define minseq0	0
#define maxseq0	11
...
#define Pinvariant	((P2 *)_this)
typedef struct P2 { /* invariant */
