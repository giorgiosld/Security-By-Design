...
/*** From source: peterson_mutual_exclusion.pml ***/
...
S_F_MAP src_file2 [] = {
	{ "-", 0, 0 },
	{ "peterson_mutual_exclusion.pml", 1, 2 },
	{ "-", 3, 4 }
};
uchar reached2 [] = {
	  0,   0,   0,   0, };
...
short src_ln1 [] = {
	  0,  28,  28,  29,  29,  34,  36,  38, 
	 39,  27,  41,  27,  41,   0, };
S_F_MAP src_file1 [] = {
	{ "-", 0, 0 },
	{ "peterson_mutual_exclusion.pml", 1, 12 },
	{ "-", 13, 14 }
};
uchar reached1 [] = {
	  0,   1,   1,   1,   0,   0,   0,   0, 
...
{	/* int i; */
	...
	printf("	bit    b1:	%d\n", now.b1);
	printf("	bit    b2:	%d\n", now.b2);
	printf("	mtype  P1_Turn:	2\n");
	printf("	mtype  P2_Turn:	1\n");
	printf("	mtype  x:	%d\n", now.x);
	printf("	byte   mutex:	%d\n", now.mutex);
}
void
...
{	/* int i; */
	...
	case 2:
		...
		break;
	case 1:
		printf("local vars proc %d (P2):\n", pid);
		break;
	case 0:
		printf("local vars proc %d (P1):\n", pid);
		break;
	}
}
void
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("P2_Turn"); return;
	case 2: Printf("P1_Turn"); return;
